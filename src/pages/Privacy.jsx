    ...
    return (
        ...
        <div className="text-lg p-6">
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li className="mb-2">
                    <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to App Machine Ltd.
                </li>
                <li className="mb-2">
                ...
                <li className="mb-2">
                    <strong>Website</strong> refers to Race Trace, accessible from racetrace.world
                </li>
                <li className="mb-2">
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li className="mb-2">
                    <strong>To contact You:</strong> To contact You by email, or other equivalent forms of electronic communication, such as a mobile application&apos;s push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.
                </li>
                <li className="mb-2">
            ...
            <h4 className="text-md font-semibold mb-2">Business Transactions</h4>
            <p className="mb-4">
                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </p>
            <h4 className="text-md font-semibold mb-2">Law enforcement</h4>
            <p className="mb-4">
                Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            <h4 className="text-md font-semibold mb-2">Other legal requirements</h4>
            <p className="mb-4">
            ...
            <ul className="list-disc list-inside mb-4">
                <li className="mb-2">By email: hello @ racetrace.world</li>
            </ul>
        </div>
        </>
    );
